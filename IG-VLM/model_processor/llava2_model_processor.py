...
class Llava2Processor(BaseModelInference):
    ...
    def load_model(self, matryoshka_vis_token_scale = None):
        ...
        if matryoshka_vis_token_scale!= None:
            self.model.config.matryoshka_vis_token_scale = matryoshka_vis_token_scale
    def inference(self, *args, **kwargs):
        ...
        with torch.inference_mode():
            output_ids = self.model.generate(
                ...
                max_new_tokens=512,
                use_cache=True,
                matryoshka_vis_token_scale = getattr(self.model.config, "matryoshka_vis_token_scale", None),
            )
